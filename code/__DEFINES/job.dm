...
#define JOB_PMC_SECURITY "PMC Security Enforcer"
...
#define ROLES_WY_PMC_INSPEC list(JOB_PMC_LEAD_INVEST, JOB_PMC_INVESTIGATOR, JOB_PMC_SECURITY, JOB_PMC_CROWD_CONTROL)
...
#define JOB_CORPORATE_ROLES_LIST list(JOB_CORPORATE_LIAISON, JOB_WO_CORPORATE_LIAISON, JOB_CORPORATE_BODYGUARD, JOB_DIRECTOR, JOB_PMC_DIRECTOR, JOB_DEPUTY_DIRECTOR, JOB_CHIEF_EXECUTIVE, JOB_DIVISION_MANAGER, JOB_ASSISTANT_MANAGER, JOB_EXECUTIVE_SUPERVISOR, JOB_LEGAL_SUPERVISOR, JOB_EXECUTIVE_SPECIALIST, JOB_LEGAL_SPECIALIST, JOB_SENIOR_EXECUTIVE, JOB_EXECUTIVE, JOB_JUNIOR_EXECUTIVE, JOB_TRAINEE, JOB_WY_SEC_SYNTH, JOB_WY_SEC)
...
#define JOB_USASF_SECURITY_POLICE "USASF Security Police"
#define JOB_USASF_OFFICER "USASF Officer"
#define JOB_USASF_CO "USASF Commander"
#define JOB_USASF_SYNTHETIC "USASF Synthetic"

#define JOB_USASF_LIST list(JOB_USASF_CREW, JOB_USASF_HANGARTECH, JOB_USASF_CARGOTECH, JOB_USASF_NURSE, JOB_USASF_DOCTOR, JOB_USASF_PILOT, JOB_USASF_SECURITY_POLICE, JOB_USASF_OFFICER, JOB_USASF_CO, JOB_USASF_SYNTHETIC)
